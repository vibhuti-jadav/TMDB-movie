...
const Discover = () => {
  ...
  const { data, isLoading, error } = showMovie.useAllMovieQuery({ endpoint: "discover/movie", page: page , lang:lang });
...
<Language  setLang={setLang}/>
    ...
    <div className="max-w-7xl mx-auto mt-10 grid grid-cols-4 gap-6">
