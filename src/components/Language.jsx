...
const Language = ({ setLang, lang }) => {
  ...
  const selectedLangName = data?.find(
    (l) => l.iso_639_1 === selectedLang
  )?.english_name;
  ...
  return (
    <div className="relative inline-block text-left mx-5 my-4">
      ...
      >
        ...
        <i
          className={`ri-arrow-down-s-line ml-2 text-lg transition-transform duration-300 ${
            open ? "rotate-180" : ""
          }`}
        ></i>
      </button>
